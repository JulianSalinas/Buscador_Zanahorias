...
def test_arrows_pointing_to_carrot():
    ...
    test = [
        ...
        [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
        [' ', ' ', 'C', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']]
    test = np.matrix(test, object)

    carrot_positions = np.nonzero(test == 'Z')

    assert arrows_pointing_to_carrots(test, carrot_positions) == 5
    ...
    assert arrows_pointing_to_carrots(test, carrot_positions) == 1
